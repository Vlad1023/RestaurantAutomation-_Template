            ...
            <v-flex v-for="dish in props.items" :key="dish.price" xs4>
              <v-card>
                ...
                <div class="display-2 ml-1">
                  <span
                    :class="{
                      'green--text font-weight-bold': sortBy === 'Title',
                    }"
                    >{{ dish.title }}</span
                  >
                  <v-btn
                ...
                <div class="mt-2 ml-1">
                  <v-btn @click="addToOrder(dish)" small color="primary"
                    >Add to order</v-btn
                  >
                </div>
                ...
                <v-card-subtitle class="mt-2 text-right">
                  <span
                    :class="{
                      'green--text font-weight-bold': sortBy === 'Price',
                    }"
                    >price: {{ dish.price }} $</span
                  >
                </v-card-subtitle>
                ...
                <v-card-subtitle class="text-right">
                  <span
                    :class="{
                      'green--text font-weight-bold': sortBy === 'Calories',
                    }"
                    >calories: {{ dish.calories }} g</span
                  >
                </v-card-subtitle>
